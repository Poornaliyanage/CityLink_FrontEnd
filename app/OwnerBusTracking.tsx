...
export default function OwnerBusTracking() {
  ...
  const { busNumber } = (route.params as { busNumber?: string }) || {};
        ...
        <SafeAreaView style={{ flex: 1, paddingTop: StatusBar.currentHeight || 0 }}>
          ...
          >
            ...
            >
              ...
              <Text style={{ fontSize: 16, fontWeight: "600", color: "#374151", marginVertical: 10 }}>
                Colombo 15 → Anuradhapura N
              </Text>

              <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 6 }}>
                <Text style={{ color: "#6b7280", fontSize: 14 }}>Driver:</Text>
              ...
              <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                <Text style={{ color: "#6b7280", fontSize: 14 }}>Conductor:</Text>
                <Text style={{ color: "#1f2937", fontWeight: "600", fontSize: 14 }}>
                  Nissanka Bandara
                </Text>
              </View>
